...
export const pluginSettingsSchema = T.Object(
  {
    ...
    alwaysRecommend: T.Optional(T.Number({ default: 0, description: "If set to a value greater than 0, the bot will always recommend contributors, regardless of the similarity score." })),
  },
  { default: {} }
);
